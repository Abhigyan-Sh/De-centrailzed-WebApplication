...
const Navbar = () => {
  ...
  return (
    <div className="flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6">
      <div className="lg:flex-1 flex flex-row max-w-[458px] pl-4 h-[52px] bg-[#1c1c24] rounded-xl">
        ...
        <div className="w-[72px] h-full rounded-xl bg-[#b1b250] flex justify-center items-center cursor-pointer">
